    ...
    <footer className="bg-gray-800 text-white w-full">
      <div className="w-full px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">EcoTrade</h3>
            <p className="text-gray-400">
              Promoting sustainable practices through eco-friendly products and recycling initiatives.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/plant-growth" className="text-gray-400 hover:text-white">
                  Plant Growth
                </Link>
              </li>
              <li>
